    ...
    <div className="fixed right-2">
      <div
        className={`text-gray-600 flex flex-col ${
          isMenuOpen ? "bg-white shadow-md" : "bg-zinc-100"
        }`}
      >
        <span
          className={`font-bold cursor-pointer flex items-center text-lg ${
            isMenuOpen
              ? "bg-white py-4 px-4 rounded-md hover:text-blue-500"
            ...
            {data?.map((friendship: IFriendship) => (
              ...
              >
                ...
                <button
                  ...
                  className={`px-3 py-1 rounded-md hover:bg-blue-400 text-white font-semibold ${
                    isMenuOpen
