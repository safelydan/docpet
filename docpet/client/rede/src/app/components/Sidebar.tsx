...
import { FaAlignLeft, FaCalendar, FaFlag, FaHeart, FaHome, FaInfoCircle, FaPeopleArrows, FaQuestionCircle, FaStore, FaUserFriends } from "react-icons/fa";
    ...
    return(
        ...
        <aside className="fixed w-1/6 pl-4">
            <nav className=" flex flex-col gap-6 text-gray-600 font-semibold">
                ...
                <Link href='/sections/faq' className="flex gap-3"> <FaInfoCircle className='w-6 h-6'/>Sobre</Link>
