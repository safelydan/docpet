...
<header className="fixed z-10 w-full bg-white flex justify-between py-2 px-4 items-center shadow-md">
        ...
        {search && searchResults && (
            <div className="absolute flex flex-col bg-white p-4 shadow-md rounded-md gap-2 border-t-3 whitespace-nowrap right-0 left-0 top-[100%]">
                {data?.map((users: IUser, id: number) => (
                    ...
                    >
                        <img
                            src={users ? users.userImg : 'https://www.digitary.net/wp-content/uploads/2021/07/Generic-Profile-Image.png'}
    ...
    <div className="flex gap-2 items-center text-gray-600">
        <div className="flex gap-3">
            {/* Adicione elementos conforme necessário */}
        </div>
        <div
            className="relative"
        ...
        >
            ...
            {showMenu && (
                <div className="absolute flex flex-col bg-white p-4 shadow-md rounded-md gap-2 border-t-3 whitespace-nowrap right-[-10px]">
                    {/* Adicione links do menu conforme necessário */}
